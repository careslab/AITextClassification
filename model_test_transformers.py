...
csv_file_path = "./dataset_large.csv"
...
model_path = "./finetuned_distilroberta"                                                                                                     ##### changes here the size!!!!
...
# Prepare CSV file
clean_model_name = "finetuned_distilroberta_fpt"                                                                                                     ##### changes here the size!!!!
